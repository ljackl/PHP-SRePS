	...
	<div class="container">
		<nav class="navbar navbar-inverse">
			<div class="navbar-header">
				<a class="navbar-brand" href="{{URL::to('sales')}}">Sales</a>
			</div>
      			...
      			@foreach($sales as $key => $value)
					<tr>
						...
						<td>
							...
							<a class="btn btn-small btn-success" href="{{URL::to('sales/'.$value->id)}}">View</a>
							<a class="btn btn-small btn-info" href="{{URL::to('sales/'.$value->id.'/edit')}}">Edit</a>
